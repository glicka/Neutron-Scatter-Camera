...
#            print('tictoc = ',toc-tic)
    print('elapsed = ',toc-tic,'s')
    plane1NeutronDets,plane1NeutronTimes,plane1NeutronPulseADC = PSD(plane1Dets,plane1Times,plane1Data,'Plane 1',slope,intercept,tic)
    print('Performing PSD on Plane 2')
    toc = time.time()
#            print('tictoc = ',toc-tic)
    print('elapsed = ',toc-tic,'s')
    plane2NeutronDets,plane2NeutronTimes,plane2NeutronPulseADC = PSD(plane2Dets,plane2Times,plane2Data,'Plane 2',slope,intercept,tic)
