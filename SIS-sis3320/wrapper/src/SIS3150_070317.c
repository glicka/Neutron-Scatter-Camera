...
//printf("in Start Data Acquisition\n");
//printf("gl_dma_rd_buffer = %i\n", gl_dma_rd_buffer);
//printf("dma_got_no_of_words = %i\n", dma_got_no_of_words);
}
...
//printf("%i\n", dma_got_no_of_words);
      ...
      //      printf("%i\n", data);
        ...
        } while (((data_rd & 0x80000) == 0x80000) && (gl_uint_RunStopStatusFlag == AQC_RUN_STATUS)) ;   // loop until IRQ
