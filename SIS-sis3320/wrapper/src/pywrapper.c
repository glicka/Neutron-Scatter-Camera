...
static PyMethodDef SISMethods[] = {
    ...
    {"configuration", (PyCFunction)wrap_configuration, METH_VARARGS, 
     "Configure SIS. (conf_fname(str), output_filename(str), save_data(bool))"},
    ...
    {"acquiredata", (PyCFunction)wrap_acquiredata, METH_VARARGS, 
     "Acquire data from SIS3150. (save_data(bool))"},
